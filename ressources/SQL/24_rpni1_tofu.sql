...
--
INSERT INTO
  `couleurs` (`id`, `nom_fr`, `nom_en`, `hexadecimal`, `rgb`)
VALUES
...
VALUES
  ...
  (
    27,
    '2 paires de chaussettes en mérinos',
    NULL,
    0,
    4
  ),
  ...
  (
    58,
    'Faire les esquisses fonctionnelles',
    '2019-11-15 00:00:00',
    0,
    2
  ),
  ...
  (
    105,
    'Une amie d\'enfer de Jacqueline Wilson',
    '2050-12-31 00:00:00',
    0,
    7
  ),
  ...
  (
    116,
    'Le dieu des petites choses de Arundhati Roy',
    '2050-12-31 00:00:00',
    0,
    7
  ),
  ...
  (
    146,
    'Mémoire d\'Adrien de Marguerite Yourcenar',
    '2050-12-31 00:00:00',
    0,
    7
  ),
  ...
  (
    153,
    'Lécume des jorus de Boris Vian',
    '2050-12-31 00:00:00',
    0,
    7
  ),
  (
    154,
    'Volskwagen blues de Jacques Poulin',
    '2050-12-31 00:00:00',
    0,
    7
  ),
...
--
INSERT INTO
  `listes` (`id`, `nom`, `couleur_id`, `utilisateur_id`)
VALUES
  (1, 'Épicerie', 3, 1),
  (2, 'Devoirs', 12, 1),
